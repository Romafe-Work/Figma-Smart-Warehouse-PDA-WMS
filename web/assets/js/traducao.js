...
(function () {
  ...
  var EN = {
    ...
    'Dar com um erro e corrigir': 'Spotting an error and fixing it',
    'Na paragem falta quantidade': 'Short quantity at the stop',
    'Ver como está uma guia': 'Checking how an order is doing',
    'Percursos': 'Paths',
    'O caminho de cada caso, do login ao fim. Clica num ecrã para o abrir.': 'The path of each case, from login to the end. Click a screen to open it.',
    ...
    'Porquê: 6 un. de Óleo 5W30 estão fora do sítio': 'Why: 6 pcs of 5W30 oil are in the wrong place',
