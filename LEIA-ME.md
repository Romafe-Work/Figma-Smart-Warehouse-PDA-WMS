...
| Ficheiro | Para quê |
| --- | --- |
| `importar/01-ecras.pdf` | **Importar no Figma ou no Canva.** Os 62 ecrãs, uma página de 320 × 533 cada, em vetor e com o texto editável |
...
| `importar/03-fluxo.png`, `importar/03-fluxo.pdf` | **O mapa de navegação.** Os 62 ecrãs numa folha, uma linha por fluxo, com uma seta de cada botão ou leitura para o ecrã a que leva |
...
| O gestor | 55 Início do gestor · 56 Relatório do turno (com os sinais) · 57 Atribuir · 58 O que está a acontecer · 59 Feito · 60 Todas as operações · 61 Insights | CU-16 a CU-20 · CU-30 |
| Quando falta a ligação (todas) | 62 Sem ligação | CU-27 · RNF-01 |
