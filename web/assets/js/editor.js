...
(function () {
  ...
  function montar() {
    ...
    ABAS.forEach(function (par) {
      var b = el('button', 'ed-aba' + (par[0].indexOf('resumo') === 0 ? ' ed-aba--larga' : ''));
      b.type = 'button';
      if (IC_ABA[par[0]]) {
...
,
  ...
  /* As páginas que ficam no painel: os ecrãs, o mapa, o texto e um resumo por
     função. O menu da app, a documentação e o como funciona continuam em web/
     e abrem pelo endereço (menu.html, documentacao.html, como-funciona.html),
     mas não ocupam o painel de quem está a desenhar. */
  var ABAS = [['', 'Ecrãs'], ['fluxo', 'Fluxo'], ['texto', 'Texto'],
