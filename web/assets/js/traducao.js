...
(function () {
  ...
  var EN = {
    ...
    'Percursos': 'Paths',
    /* ── a fila do gestor e o chamar por ajuda (25 set.) ── */
    'A fila de trabalho': 'The work queue',
    'A fila do armazém': 'The warehouse\'s queue',
    'A fila': 'Queue',
    '8 à espera': '8 waiting',
    'Por ordem do motor. Ninguém vê isto senão tu.': 'In the engine\'s order. Nobody sees this but you.',
    'Picar o camião da Castrol': 'Scan the Castrol truck',
    'Porquê: está no cais há 14 min e prende-o': 'Why: it has been at the dock for 14 min and is holding it',
    'Porquê: mandaste-a tu, às 10h22': 'Why: you ordered it, at 10:22',
    'Toca numa para a dar a alguém. Quem trabalha vê só a que tem em mãos: a fila é tua.': 'Tap one to give it to someone. Whoever is working sees only the one in hand: the queue is yours.',
    'Chamar o gestor': 'Call the manager',
    'Chamar': 'Call',
    'Ele vai saber': 'He will know',
    'Onde estás': 'Where you are',
    'Zona 30 · 60300401': 'Zone 30 · 60300401',
    'O que tens em mãos': 'What you have in hand',
    'Guia GA-4471': 'Note GA-4471',
    'Diz-lhe o que é, para ele saber se vem ou se responde daí.': 'Tell him what it is, so he knows whether to come or answer from there.',
    'Não sei o que fazer a isto': 'I do not know what to do with this',
    'O que está aqui não é o que o PDA diz': 'What is here is not what the PDA says',
    'Preciso de ajuda para mexer nisto': 'I need a hand moving this',
    'O gestor foi chamado': 'The manager has been called',
    'Paulo Mendes · avisado às 10h26': 'Paulo Mendes · told at 10:26',
    'Enquanto esperas': 'While you wait',
    'A tarefa': 'The task',
    'fica contigo': 'stays with you',
    'O motor': 'The engine',
    'não te dá outra': 'does not give you another',
    'Ele vê onde estás e o que tens em mãos. Se não puder vir, responde pelo PDA — e se for preciso, faz ele a tarefa, que pode fazer o que qualquer função faz.': 'He sees where you are and what you have in hand. If he cannot come, he answers on the PDA — and if need be he does the task himself, because he can do whatever any role does.',
    'Continuar a tarefa': 'Carry on with the task',
    'Chamada': 'Call',
    'Marta Silva chamou-te, há 2 min': 'Marta Silva called you, 2 min ago',
    'Zona 30 · «Não sei o que fazer a isto» · está parada à espera': 'Zone 30 · "I do not know what to do with this" · she is stopped, waiting',
    'Ver todos (6)': 'See all (6)',
    'Ver a fila e dar uma tarefa': 'See the queue and give out a task',
    'O gestor é o único que vê a fila toda, e porque é que cada tarefa está naquela ordem. De lá pode dar uma a alguém.': 'The manager is the only one who sees the whole queue, and why each task is in that order. From there he can give one to someone.',
    'Quem tem uma dúvida chama o gestor sem largar a tarefa: ele vê onde a pessoa está e o que tem em mãos. Enquanto espera, a tarefa fica com ela e o motor não lhe dá outra.': 'Anyone with a doubt calls the manager without dropping the task: he sees where they are and what they have in hand. While they wait, the task stays with them and the engine gives them no other.',
    'Faz tudo o que as outras funções fazem — não para mandar, mas para ajudar quem está a precisar. Fica registado em nome dele.': 'He does everything the other roles do — not to boss, but to help whoever needs it. It is recorded in his name.',
    'Mostrar ao gestor a fila toda: o que espera, porque está naquela ordem, e quem está a fazer o quê. É o único que a vê.': 'Showing the manager the whole queue: what is waiting, why it is in that order, and who is doing what. He is the only one who sees it.',
    'Chamar o gestor sem largar a tarefa, e dizer-lhe onde se está e porquê.': 'Calling the manager without dropping the task, and telling him where you are and why.',
    'Confirmar que o gestor foi chamado, e que a tarefa não se perde à espera dele.': 'Confirming the manager has been called, and that the task is not lost while waiting for him.',
    'Dar ao gestor tudo o que as outras funções fazem, para poder ajudar quem está a precisar — e não só mandar.': 'Giving the manager everything the other roles do, so he can help whoever needs it — not just give orders.',
    /* ── a expedição e o gestor, caso a caso (25 set.) ── */
    'Quantas paletes?': 'How many pallets?',
    'Do registo': 'From the log',
    'Encostou às': 'Pulled in at',
    '10h05 · cais de entrada': '10:05 · goods-in dock',
    'Conta o que está no cais. O que vem dentro só se sabe ao conferir.': 'Count what is on the dock. What is inside is only known when it is checked.',
    'Lê a guia do fornecedor, se tiver código de barras': 'Scan the supplier note, if it has a barcode',
    'Isto é a guia do fornecedor, não o que ele mandou de facto. O que entra em stock é o que confirmares aqui, com o teu nome.': 'This is the supplier note, not what they actually sent. What goes into stock is what you confirm here, with your name on it.',
    'Contar o que está no cais. Quem trouxe já veio do registo; o que vem dentro só se sabe ao conferir.': 'Counting what is on the dock. Who brought it came from the log; what is inside is only known when it is checked.',
    'Registar e ficar com ela': 'Log it and take it',
    'Só registar': 'Just log it',
    'O motor deu-ta a ti porque estás livre e estás no cais. Se não estivesses, dava-a a quem acabasse primeiro. A mercadoria fica no cais até alguém começar.': 'The engine gave it to you because you are free and you are at the dock. If you were not, it would go to whoever finished first. The goods stay at the dock until someone starts.',
    'O camião chega e o gestor não está': 'The truck arrives and the manager is away',
    'Registar não é escolher trabalho: é dizer ao sistema que o camião está lá. Quem está no cais e livre fica com a tarefa na hora; quem não está, só regista e o motor dá-a a quem acabar primeiro.': 'Logging is not picking work: it is telling the system the truck is there. Whoever is at the dock and free takes the task on the spot; whoever is not just logs it, and the engine gives it to whoever finishes first.',
    'Pôr a chegada de um camião dentro do sistema, que é o que cria a tarefa de picar. De quem der por ele — o gestor, ou quem está no armazém.': 'Getting a truck arrival into the system, which is what creates the scan task. By whoever spots it — the manager, or whoever is in the warehouse.',
    'Faltam 2 min': '2 min left',
    'O teu turno acaba às 16h30': 'Your shift ends at 16:30',
    'Palete vazia ao parque · 2 min': 'Empty pallet to the yard · 2 min',
    'É o que cabe no que falta': 'It is what fits in the time left',
    'As guias grandes ficam para o turno seguinte': 'The big notes wait for the next shift',
    'O motor já não dá o que não cabe em 2 min. Uma tarefa começada acaba-se: ninguém é interrompido.': 'The engine no longer hands out what will not fit in 2 min. A task already started gets finished: nobody is interrupted.',
    'Fim do turno à vista': 'End of shift in sight',
    'Falta pouco para o fim do turno': 'The shift is nearly over',
    'O motor sabe a que horas o turno acaba e deixa de dar o que não cabe no tempo que resta: dá as curtas, ou nenhuma. Uma tarefa já começada não é interrompida.': 'The engine knows when the shift ends and stops handing out what will not fit in the time left: it gives the short ones, or none. A task already started is never interrupted.',
    ...
    'O sistema não sabe o que vem a caminho. Enquanto isto não for registado, o camião não existe para o motor.': 'The system does not know what is coming. Until this is logged, the truck does not exist for the engine.',
    'Quem trouxe': 'Who brought it',
    'Onde encostou': 'Where it pulled in',
    'Quantas paletes vieram conta-as quem for picar. Isto só cria a tarefa — e é agora que o relógio começa.': 'Whoever scans it counts the pallets. This only creates the task — and the clock starts now.',
    'Criar a tarefa de picar': 'Create the scan task',
    'Ela recebe-a como a seguinte, e o motor aprende com a atribuição. Uma chegada registada nasce da mesma maneira: vira tarefa e vai para quem acabar primeiro.': 'She gets it as her next one, and the engine learns from the assignment. A logged arrival is born the same way: it becomes a task and goes to whoever finishes first.',
    'É a guia seguinte do mesmo camião: já estás lá': 'It is the next order for the same truck: you are already there',
    'Quando a última guia subir, a saída fecha sozinha. Fechar antes disso é decisão de quem está no cais, e o PDA pergunta primeiro. Documentos de transporte: no computador da expedição.': 'When the last order goes up, the dispatch closes by itself. Closing before that is the call of whoever is at the dock, and the PDA asks first. Transport paperwork: on the shipping desk computer.',
    'Fica um sinal no relatório: a guia saiu da prateleira sem um volume que devia lá estar. O gestor decide quem o vai procurar — a expedição não manda trabalho à separação.': 'A signal goes on the report: the order left the shelf without a parcel that should have been there. The manager decides who goes looking for it — shipping does not hand work to picking.',
    '5 volumes no camião, 4 ainda na prateleira': '5 parcels on the truck, 4 still on the shelf',
    'Os 5 que já subiram': 'The 5 already loaded',
    'ficam registados': 'stay recorded',
    'Os 4 que faltam': 'The 4 left',
    'voltam ao motor com a guia': 'go back to the engine with the order',
    'A saída DPD': 'The DPD dispatch',
    'Nenhum volume desce do camião: os que já subiram ficam lá e registados. Quem apanhar a guia continua no volume 6, e o camião espera no cais até a saída fechar. O gestor vê quem saiu com uma guia aberta.': 'No parcel comes back off the truck: the ones already loaded stay there and recorded. Whoever picks the order up carries on at parcel 6, and the truck waits at the dock until the dispatch closes. The manager sees who left an order open.',
    'Nenhum volume desce do camião: os que subiram ficam registados, os que faltam voltam ao motor com a guia, e a saída fica aberta.': 'No parcel comes back off the truck: the loaded ones stay recorded, the missing ones go back to the engine with the order, and the dispatch stays open.',
    'A guia vai incompleta e o resto do camião segue. Fica um sinal no relatório: faltava na prateleira um volume que a separação lá deixou.': 'The order goes incomplete and the rest of the truck moves on. A signal goes on the report: a parcel picking left on the shelf was not there.',
    /* ── a separação, caso a caso (24 set.) ── */
    'As paragens ficam na zona 20, ao pé de onde acabaste': 'The stops are in zone 20, close to where you finished',
    'Mais 6 paragens, na ordem mais curta. A prateleira já está reservada para esta guia: é lá que ela fica, inteira ou a meio.': '6 more stops, in the shortest order. The shelf slot is already held for this order: that is where it goes, whole or half done.',
    'As 2 que tiraste ficam na guia. A diferença fica registada nesta posição e o gestor vê o sinal — mexer no stock é decisão dele.': 'The 2 you took stay on the order. The difference is recorded on this location and the manager sees the signal — moving stock is their call.',
    'Incompleta, ficava na mesma prateleira à espera: o motor volta a dá-la a alguém assim que o stock entrar.': 'Incomplete, it would wait on the same shelf: the engine hands it out again as soon as the stock comes in.',
    'A expedição leva-a quando o camião chegar. Incompleta, não entrava na fila da expedição: ficava na prateleira, e o motor dava-a outra vez a alguém quando o stock entrasse.': 'Shipping takes it when the truck arrives. Incomplete, it would not reach shipping: it stays on the shelf, and the engine hands it out again when the stock comes in.',
    'Tens a guia G-24187 a meio': 'You have order G-24187 half done',
    '5 linhas recolhidas, 4 por recolher': '5 lines picked, 4 still to pick',
    'O que já tiraste': 'What you have taken',
    'leva a PP-DPD-03': 'take it to PP-DPD-03',
    'As 4 que faltam': 'The 4 left',
    'Nada volta à prateleira de origem: o que está no carro vai para a posição desta guia, e as linhas ficam registadas. Quem a apanhar continua na paragem 6 e junta o resto no mesmo sítio. O gestor vê quem saiu com uma guia aberta.': 'Nothing goes back to the racks: what is on the trolley goes to this order\'s slot, and the lines are recorded. Whoever picks it up carries on at stop 6 and adds the rest in the same place. The manager sees who left an order open.',
    'Sair com a guia a meio': 'Leaving with the order half done',
    'Uma tarefa é uma guia. O motor ordena as paragens pelo caminho mais curto e escolhe a guia seguinte pela hora do camião e por onde a pessoa acabou — é isso que substitui o lote. A prateleira é reservada à cabeça.': 'A task is one order. The engine puts the stops in the shortest order and picks the next order by the truck\'s time and by where the person finished — that is what replaces the batch. The shelf slot is held from the start.',
    'O que se tirou fica na guia; a diferença fica assinalada na posição e o gestor decide. A guia não sai sem o resto, e volta a ser tarefa quando o stock entrar.': 'What was taken stays on the order; the difference is flagged on the location and the manager decides. The order does not leave without the rest, and becomes a task again when the stock comes in.',
    'O que está no carro não volta às prateleiras: vai para a posição reservada à guia, e as linhas ficam registadas. Quem a apanhar continua na paragem seguinte.': 'What is on the trolley does not go back to the racks: it goes to the slot held for the order, and the lines are recorded. Whoever picks it up carries on at the next stop.',
    'Sair com trabalho a meio': 'Leaving with work half done',
    '24 set.: o que já se recolheu não volta às prateleiras. Vai para a posição reservada à guia e fica registado; o resto volta ao motor.': '24 Sep: what has been picked does not go back to the racks. It goes to the slot held for the order and is recorded; the rest goes back to the engine.',
    ...
    'Fechar mesmo': 'Close it anyway',
    'Voltar a carregar': 'Back to loading',
    'Fechar a saída?': 'Close the dispatch?',
    'Corrigir 60300302?': 'Fix 60300302?',
    'O sistema diz 12 e vais registar 6. Ficam menos 6 unidades em stock, e o gestor vê a diferença no relatório.': 'The system says 12 and you are about to record 6. Stock drops by 6, and the manager sees the difference in the report.',
    'Voltar a contar': 'Back to counting',
    'Corrigir o stock?': 'Fix the stock?',
    ...
    'Uma tarefa é uma guia: levanta-se na prateleira, confere-se volume a volume e leva-se ao camião. Fechar a saída pergunta antes: é o que não tem volta.': 'A task is one order: collected from the shelf, checked parcel by parcel and taken to the truck. Closing the dispatch asks first: that is the one with no way back.',
    /* ── o PDF dos casos de uso ── */
    'Mudou a 24 de setembro: deixou de ser tarefa da fila. Quem pica a chegada (CU-40) confere e recebe logo a seguir, no mesmo fluxo.': 'Changed on 24 September: it is no longer a queue task. Whoever scans the arrival (CU-40) checks it and books it in right after, in the same flow.',
    'Receber a guia da vez': 'Get the order of the moment',
    'Mudou a 24 de setembro: acabou o lote. O motor dá uma guia de cada vez, conforme a atividade dos PDA.': 'Changed on 24 September: the batch is gone. The engine gives one order at a time, by what the PDAs are doing.',
    'Ver o que fazer a seguir': 'See what to do next',
    'Mudou a 24 de setembro: a pessoa não vê a fila. O motor dá uma tarefa de cada vez, conforme a atividade dos PDA, e ela vê só a que tem em mãos.': 'Changed on 24 September: the person does not see the queue. The engine gives one task at a time, by what the PDAs are doing, and they only see the one in hand.',
    'Novo — não está no dossiê. A pessoa carrega em «Começar» e o motor entrega-lhe uma tarefa; ao acabar essa, entrega a seguinte. Ela não escolhe nem vê a fila (24 set.).': 'New — not in the dossier. The person taps "Start" and the engine hands them a task; when that one is done, it hands the next. They neither pick nor see the queue (24 Sep).',
